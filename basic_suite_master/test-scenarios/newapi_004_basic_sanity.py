...
def _get_vnic_profile(api, cluster_name, network_name):
    for vnic_profile in api.clusters.get(cluster_name).networks.get(network_name).vnicprofiles.list()
