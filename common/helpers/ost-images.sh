...
OST_IMAGES_DISTRO=${OST_IMAGES_DISTRO:=centos9}
...
OST_IMAGES_STORAGE=${OST_IMAGES_STORAGE:=${OST_IMAGES_DIR}/${OST_IMAGES_DISTRO}-storage.qcow2}
...
OST_IMAGES_STORAGE_PACKAGE=${distro_package_base}storage

for i in OST_IMAGES_BASE OST_IMAGES_ENGINE_INSTALLED OST_IMAGES_HOST_INSTALLED OST_IMAGES_HE_INSTALLED OST_IMAGES_STORAGE OST_IMAGES_SSH_KEY; do
