...
if [[ -n $engine_pg_scl ]]; then
    ...
    case "${pgver}" in
        postgresql-10.6*el8*)
            pgdg=https://download.postgresql.org/pub/repos/yum/10/redhat/rhel-8-x86_64/pgdg-redhat-repo-42.0-11.noarch.rpm
            ;;
        postgresql-12*el8*)
            pgdg=https://download.postgresql.org/pub/repos/yum/12/redhat/rhel-8-x86_64/pgdg-redhat-repo-42.0-11.noarch.rpm
            ;;
        *)
