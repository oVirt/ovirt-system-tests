...
he_deploy() {
    ...
    cd $PREFIX
    echo "#########################"
    echo "Deploying the host lago_he_basic_suite_3_6_host0"
    lago copy-to-vm \
        lago_he_basic_suite_3_6_host0 \
    ...
    echo "#########################"
    echo "Deploying the host lago_he_basic_suite_3_6_host1"
    lago copy-to-vm \
        lago_he_basic_suite_3_6_host1 \
