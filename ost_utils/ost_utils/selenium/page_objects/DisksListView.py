...
class DisksListView(EntityListView):
    ...
    def __init__(self, ovirt_driver):
        super(DisksListView, self).__init__(ovirt_driver, 'disks', ['Storage', 'Disks'], 'MainDiskView_table_content_col0_row')
    ...
    def upload(self, image_local_path, image_name):
        LOGGER.debug('Upload image from local path ' + image_local_path,)
        ...
        self.ovirt_driver.wait_long_until('Waiting for disk to appear in disk list', lambda: image_name in self.get_entities())
